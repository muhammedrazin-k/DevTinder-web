...
const EditProfile = ({ user }) => {
  ...
  return (
    <div className="flex items-center my-10 flex-col lg:flex-row justify-center">
            <UserCard user={{ firstName, lastName, age, gender, about, photoUrl }} />

      <div className="flex  my-5 lg:mx-5 shadow-[2px_18px_20px_rgba(0,0,0,0.9)]">
        <div className="card  bg-gradient-to-tr from-blue-300 to-fuchsia-300  w-80 sm:w-96 ">
